    ...
    <div className="bg-gray-800 text-white p-5">
      ...
      <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <ul className="mt-2">
            <li><Link href="/" className="hover:text-gray-300">Style</Link></li>
            <li><Link href="/" className="hover:text-gray-300">Fashion</Link></li>
            <li><Link href="/" className="hover:text-gray-300">Coding</Link></li>
            <li><Link href="/" className="hover:text-gray-300">Travel</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="mt-2">
            ...
            <li><Link href="/" className="hover:text-gray-300">Tiktok</Link></li>
